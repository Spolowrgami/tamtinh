...
theTime.add({
	...
	update: function(percent) {
		...
		document.querySelector('.container .sup').innerHTML= " Tim đập chắc ngừng thở mất " + (thePercent+899);
	}
});
theTime.add({
	targets: getHeart,
...
document.querySelector('.Description .modal-body').innerHTML = 'Daan lỡ thích Nhi mất rồi ❤❤❤ <i class="fas fa-heart"></i> ';
